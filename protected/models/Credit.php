...
class Credit extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('bcaid, credit, date', 'required'),
			array('bcaid, credit', 'numerical', 'integerOnly'=>true),
			array('date', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, bcaid, credit, date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('bcaid',$this->bcaid);
