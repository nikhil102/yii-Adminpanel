 ...
 * @property string $master_tablename
...
class Query extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('passid, query, type, master_tablename, coment', 'required'),
			array('passid', 'numerical', 'integerOnly'=>true),
			array('type, master_tablename', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, passid, query, type, master_tablename, coment', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'query' => 'Query',
			'type' => 'Type',
			'master_tablename' => 'Master Tablename',
			'coment' => 'Coment',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('master_tablename',$this->master_tablename,true);
