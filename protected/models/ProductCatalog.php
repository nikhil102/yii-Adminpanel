 ...
 * @property string $catalog_uniquename
...
class ProductCatalog extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('product_uniquename, subcategory_uniquename, category_uniquename, catalog_uniquename', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_product, product_uniquename, subcategory_uniquename, category_uniquename, catalog_uniquename, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'catalog_uniquename' => 'Catalog Uniquename',
			'status' => 'Status',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('catalog_uniquename',$this->catalog_uniquename,true);
