...
class DOCXTemplate {
  ...
  //  echo "var==".$var;
  //  echo "value==".$value;
  //  echo"<pre>"; print_r($this->data[entries][5]);
...
//			$bE = ($aP['GPF'] && 0x0001) ? TRUE : FALSE;
    ...
    public function getdocumentstring() {
        ...
        return $this->package['entries'][5]['data'];
    }
    public function setdocumentstring($serachsrting,$replacestring) {
		
       $this->package['entries'][5]['data'] = str_replace($serachsrting,$replacestring,$this->package['entries'][5]['data']);
       return $this->package['entries'][5]['data'];
    }
...
//    }
     ...
     function downloadAs( $filename, $filepath, $exit = true ) {
        if ( !$this->_parse() ) return false;
        //php://stdin
